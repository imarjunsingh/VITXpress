...
<h3>Contact Form</h3>
  <form method="post" action="contact.php">
    <label class="namepad" for="fname">First Name:</label>
    <input type="text" id="fname" name="firstname" placeholder="Your first name.." required>

    <label class="namepad" for="lname">Last Name:</label>
    <input type="text" id="lname" name="lastname" placeholder="Your last name.." required>

    <label class="namepad" for="country">Email    :</label>&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;
    <input type="email" id="lname" name="email" placeholder="Your emai.." required>

    <label class="namepad" for="subject">Subject:</label>
